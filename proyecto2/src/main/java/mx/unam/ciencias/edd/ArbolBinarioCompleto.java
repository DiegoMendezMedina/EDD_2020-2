...
public class ArbolBinarioCompleto<T> extends ArbolBinario<T> {
	...
	Vertice l=new Vertice(elemento);
	elementos++;
	if(esVacia())
	    raiz=l;
	else{
	...
	if(v==null|| esVacia()||elemento==null)
	    return;
	    elementos--;
	    if(elementos==0){
		raiz=null;
	    ...
	    Vertice aux=vertice(ultimoVertice());
    ...
    /**
     *Metodo auxiliar para eliminar, obtiene el ultimo vertice.
     **/
    ...
    /**
     *Metodo auxiliar intercambia. Dados dos vertices
     *cambia tal que a=b si y solo si b=a
     **/
